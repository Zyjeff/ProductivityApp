// logbook.jsx — "what the yard remembers". Nightwatch renders the
// Logbook as a full-page overlay (same statsOpen state, same `4` and
...
function Inner() {
  ...
  return (
    <div className="logbook-page" role="dialog" aria-label="Logbook">
      <div className="view-pad">
        <div className="header-band" style={{ marginBottom: 24 }}>
          ...
          <div className="w-stencil-row" style={{ marginBottom: 10 }}>
            <span className="w-stencil w-stencil--lit">Logbook · the record</span>
          </div>
          <div className="greeting-row">
            <h1 className="w-display greeting">What the yard remembers.</h1>
