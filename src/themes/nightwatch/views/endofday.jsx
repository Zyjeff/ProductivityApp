...
function Inner() {
  ...
  return (
    <div onClick={() => setUI({ endOfDayOpen: false })}
      ...
      <div onClick={(e) => e.stopPropagation()} className="console fade-in" style={{ width: "100%", maxWidth: 440 }}>
        <div className="console-head">
          <span className="w-tape"><Icon name="moon" size={10} /> End of watch</span>
          <div style={{ flex: 1 }} />
        ...
        <div style={{ padding: "16px 20px 20px" }}>
          ...
          <div className="w-num" style={{ fontSize: 9.5, color: "var(--fg-faint)", marginTop: 10, textAlign: "center", letterSpacing: "0.08em" }}>
            EIGHT BELLS. THAT'S ENOUGH FOR TODAY.
          </div>
        </div>
      </div>
    </div>
