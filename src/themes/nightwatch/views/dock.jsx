...
// the rail, and the yard library with a one-click "Berth" assign.
            ...
            {open && (
              <div className="fade-in" style={{ marginTop: 8, padding: "10px 10px 10px 12px", background: "var(--well)", boxShadow: "inset 0 1px 0 var(--line-dim)" }}>
                ...
                <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
                  ...
                  <button className="bezel bezel--sm" onClick={() => unshipProject(p.id)} title="Back to the yard">Unlaunch</button>
                </div>
              </div>
            )}
          </div>
...
function LibraryTab() {
  ...
  return (
    <>
      ...
      {list.length === 0 ? (
        <EmptyState caption="nothing in the yard">Nothing matches.</EmptyState>
      ) : (
