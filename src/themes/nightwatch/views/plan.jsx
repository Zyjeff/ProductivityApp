...
// ("Ask the yard… Transmit"). All state, handlers, and data flow
                ...
                return (
                  <div key={day.iso} className={"tide-day" + (day.isToday ? " tide-day--today" : "") + (day.locked ? " tide-day--locked" : "")}>
                    ...
                    <div className="plate plate--flush"
                      ...
                      {day.items.length === 0
                        ? <div className="w-num" style={{ padding: "0 12px 10px", fontSize: 10, color: "var(--fg-faint)" }}>{day.cap === 0 ? "REST — the yard is closed." : "nothing moored"}</div>
                        : viewMode === "cards"
      ...
      {(plan || []).length > 0 && (
        <div style={{ paddingRight: 34, paddingBottom: 56 }}>
          <div className="radio-console">
            <span className="w-tape">Ask the yard</span>
