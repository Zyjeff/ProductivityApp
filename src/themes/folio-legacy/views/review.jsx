...
function Inner({ week }) {
  ...
  return (
    <div onClick={closeReview} className="w-backdrop" style={{ zIndex: 10002, display: "flex", alignItems: "flex-start", justifyContent: "center", padding: "6vh 16px 16px", overflowY: "auto" }}>
      <div onClick={(e) => e.stopPropagation()} className="w-console w-fade-in f-review" role="dialog" aria-modal="true" aria-label="Weekly review" style={{ width: "100%", maxWidth: 640 }}>
        <div className="w-console-head">
          <span className="w-stencil w-stencil--lit">The weekly edition</span>
          <div style={{ flex: 1 }} />
        ...
        {stats.total === 0 ? (
          ...
          <>
            ...
            <div className="f-review-retro" style={{ borderTop: "1px solid var(--line-dim)", paddingTop: 14 }}>
