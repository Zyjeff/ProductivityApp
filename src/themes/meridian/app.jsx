...
import { JournalPage } from "./views/logbook.jsx";
...
const NAV = [
  { id: "today", label: "Session", icon: "today", key: "1" },
  { id: "plan", label: "Ephemeris", icon: "calendar", key: "2" },
  { id: "dock", label: "Bay", icon: "anchor", key: "3" },
];
      ...
      <aside className="mast">
        <div className="mast-brand">
          ...
          <div className="brand-text">
            <div className="w-display mast-brand-name">MERIDIAN</div>
            <div className="w-stencil" style={{ fontSize: 8, marginTop: 3 }}>the observatory</div>
          </div>
        </div>
        ...
        <nav className="mast-nav">
          ...
          <button className={"slot" + (statsOpen ? " slot--active" : "")} onClick={() => setUI({ statsOpen: !statsOpen })} title="Journal — the record, settings, data (4)">
            <span className="slot-glyph"><Icon name="stats" size={14} /></span>
            <span className="slot-label">Journal</span>
        ...
        <div className="mast-foot">
          ...
          <div className="draught">
            ...
            <div className="draught-read">
              ...
              <div className="w-num" style={{ marginTop: 4, fontSize: 9, color: "var(--fg-faint)" }}>{draughtM}M ALTITUDE</div>
              <div className="w-num" style={{ marginTop: "auto", paddingTop: 8, fontSize: 9.5, color: "var(--fg-faint)", display: "flex", flexDirection: "column", gap: 2 }}>
                ...
                {streakRun > 0 && <span style={{ color: "var(--amber-hot)" }}>{streakRun}- CLEAR NIGHTS</span>}
              </div>
            </div>
          </div>
      ...
      <main className="deck">
        ...
        {previewMode && (
          <div style={{ position: "sticky", top: 34, zIndex: 19, display: "flex", alignItems: "center", gap: 12, padding: "7px 18px", background: "var(--amber)", color: "var(--ink)" }}>
            ...
            <span style={{ font: "500 12px var(--t-body)", flex: 1 }}>Sample data — your real observatory is snapshotted and comes back on exit.</span>
