...
function PaletteInner() {
  ...
  const aliases={'view-today':'Sanctum · Today','view-plan':'Almanac · Plan','view-dock':'Collections · Projects & library',stats:'Codex · Progress & settings',rollover:'Day rollover · Codex settings',review:'Weekly reflection',brief:'Daily brief',help:'Keyboard shortcuts'};
  ...
  const items = useMemo(() => {
    ...
    const commands = buildCommands().map((c) => ({ type: "cmd", id: c.id, label: aliases[c.id] || c.label, search: c.label, keys: c.keys, run: c.run }));
