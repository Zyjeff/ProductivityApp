...
function Inner({ week }) {
  ...
  return (
    <div onClick={closeReview} className="backdrop" style={{ zIndex: 10002, display: "flex", alignItems: "flex-start", justifyContent: "center", padding: "6vh 16px 16px", overflowY: "auto" }}>
      <div onClick={(e) => e.stopPropagation()} className="console v-reflection" style={{ width: "100%", maxWidth: 930 }}>
        <div className="console-head">
          <span className="w-stencil w-stencil--lit">Weekly reflection</span>
          <div style={{ flex: 1 }} />
