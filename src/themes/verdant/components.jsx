...
export function GhostFoot({ caption, tone = "#354b2c", height = 44 }) {
  const url = useMemo(
    () => tex({ seed: "verdant-grain-" + tone, algo: "noise", w: 240, h: height, cell: 2, fg: tone, grad: { from: 0.4, to: 0.02, dir: "up" } }),
    [tone, height]
  );
  return (
    <div aria-hidden>
