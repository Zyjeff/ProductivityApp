...
export function tex(opts) {
  ...
  const { seed = "verdant", algo = "bayer", w = 96, h = 96, cell = 2, fg = "#9cf16f", bg = null, alpha = 1 } = opts;
...
export function plateFade(seedString, fg = "#293d29", from = 0.35, depth = 20) {
...
export function statementBg(seedString, ink = "#102012", amber = "#243d23") {
