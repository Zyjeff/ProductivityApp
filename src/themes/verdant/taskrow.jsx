    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        ...
        <div style={{ flex: 1, minWidth: 0, cursor: onToggleExpand ? "pointer" : "default" }}
          role={onToggleExpand ? "button" : undefined} tabIndex={onToggleExpand ? 0 : undefined} aria-label={onToggleExpand ? (expanded ? "Collapse " : "Expand ") + task.title : undefined} aria-expanded={onToggleExpand ? !!expanded : undefined} onKeyDown={e=>{if(onToggleExpand && (e.key==="Enter"||e.key===" ")){e.preventDefault();e.stopPropagation();onToggleExpand();}}} onClick={onToggleExpand || undefined}>
